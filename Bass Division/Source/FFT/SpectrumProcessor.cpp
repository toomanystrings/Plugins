...
// TODO: Make the circularBuffer dependant of the buffer size of the incoming audio stream.
    circularBuffer    (juce::jmax (int (fftEngine.getMagnitudesBuffer().getSize() * 4), 2048)),
    needToProcess     {false},
    detectedFrequency {juce::var(0)},
...
juce::Value& SpectrumProcessor::getRepaintViewerValue()
{
...
juce::Value& SpectrumProcessor::getDetectedFrequency()
{
