...
//==============================================================================
MidGUI::MidGUI(BassDivisionAudioProcessor& p) : BDPanelBase(p), audioProcessor(p)
{
	...
	gainSliderAttachment = std::make_unique<juce::AudioProcessorValueTreeState::SliderAttachment>(audioProcessor.treeState, "MID_DISTORTION_GAIN", gainSlider);
	...
	wetDrySliderAttachment = std::make_unique<juce::AudioProcessorValueTreeState::SliderAttachment>(audioProcessor.treeState, "MID_DISTORTION_WETDRY", wetDrySlider);
	...
	typeSliderAttachment = std::make_unique<juce::AudioProcessorValueTreeState::SliderAttachment>(audioProcessor.treeState, "MID_DISTORTION_TYPE", typeSlider);
	...
	edgeSliderAttachment = std::make_unique<juce::AudioProcessorValueTreeState::SliderAttachment>(audioProcessor.treeState, "MID_DISTORTION_EDGE", edgeSlider);
	...
	soloButtonAttachment = std::make_unique<juce::AudioProcessorValueTreeState::ButtonAttachment>(audioProcessor.treeState, "MID_SOLO", soloButton);
...
void MidGUI::paint(juce::Graphics& g)
{
	...
	//g.setFont(25);
	g.drawText("MIDS", 0, 0, getWidth(), getHeight() - 15, juce::Justification::centredBottom);

	

	// TODO: Code for drawing the trunk of the tree that will sit behind the knobs
}
...
void MidGUI::buttonClicked(juce::Button* button)
{
}
